...
public class PS_LVF_PARAM_GENER_Service implements PS_LVF_PARAM_GENER_DAO {
    ...
    public String months() {
        return psLvfParamGenerDao.months();
    }
    ...
    @Override
    public <S extends PS_LVF_PARAM_GENER, R> R findBy(Example<S> example, Function<FluentQuery.FetchableFluentQuery<S>, R> queryFunction) {
        return null;
    }
}
